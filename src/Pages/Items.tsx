...
function Items() {
  return (
    ...
    <div className={style.grid}>
      <div>
          <img src={vaccumPic} alt='looks like its broken'></img> <button className={style.buyBut}>Buy Now!</button>
        ...
        <div>
          <img src={broomPic} alt='looks like its broken'></img> <button className={style.buyBut}>Buy Now!</button>
        ...
        <div>
          <img src={dishwasherPic} alt='looks like its broken'></img> <button className={style.buyBut}>Buy Now!</button>
        ...
        <div>
          <img src={laundryPic} alt='looks like its broken'></img> <button className={style.buyBut}>Buy Now!</button>
        ...
        <div>
          <img src={lawnPic} alt='looks like its broken'></img> <button className={style.buyBut}>Buy Now!</button>
        ...
        <div>
          <img src={hosePic} alt='looks like its broken'></img> <button className={style.buyBut}>Buy Now!</button>
